" SearchStandardSearch.vim: Re-activate the normal, built-in search in SearchRepeat.
"
" DEPENDENCIES:
...
if exists('g:loaded_SearchStandardSearch') || (v:version < 702)
    finish
endif
let g:loaded_SearchStandardSearch = 1
...
nnoremap <silent> <Plug>(SearchStandardSearchNext) :<C-u>let v:searchforward=1<Bar>execute 'normal!' v:count1 . 'nzv'<CR>
if ! hasmapto('<Plug>(SearchStandardSearchNext)', 'n')
    nmap go/ <Plug>(SearchStandardSearchNext)
endif
nnoremap <silent> <Plug>(SearchStandardSearchPrev) :<C-u>let v:searchforward=0<Bar>execute 'normal!' v:count1 . 'nzv'<CR>
if ! hasmapto('<Plug>(SearchStandardSearchPrev)', 'n')
    nmap gO/ <Plug>(SearchStandardSearchPrev)
